...
def fix_eval_notebook():
    ...
    for cell in nb['cells']:
        ...
        # --- 確保 notebook 至少有 12 個 cells (索引 0 到 11) ---
    ...
    # --- 倒數邊二個 Cell (Cell 10) 強真設為自訂路徑測試 Cell（完全獨立，不依賴前面 Cell）---
    nb['cells'][-2]['source'] = [
        "# ==============================================================================\n",
        "# 🎯 自訂單張影像 Grad-CAM 視覺化與分析（參數調整測試用）\n",
    ...
    # --- 最後一個 Cell (Cell 11) 強制設為簡報專用雙Y軸決策對比圖繪製 Cell ---
    nb['cells'][-1]['source'] = [
        "# ==============================================================================\n",
        ...
        "\n",
        "    # 6. 建立統一圖例 (包含 mAP@0.5, mAP@0.5:0.95 與訓練時間)\n",
    ...
    print("✅ Cell 11（簡報專用折線與柱狀對照圖）已強制還原。")
